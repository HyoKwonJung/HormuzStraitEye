...
Hormuz Security Dashboard is a public OSINT dashboard focused on maritime security risk and operational risk signals around the Strait of Hormuz.

## Disclaimer

This dashboard uses public-source operational and maritime security signals, **not classified military data**.
It is intended for situational awareness, experimentation, and public-facing risk monitoring.
